module Hydra::PCDM
  class RemoveRelatedObjectFromObject
    ...
    def self.call( parent_object, child_related_object )
      ...
      warn "[DEPRECATION] `Hydra::PCDM::RemoveRelatedObjectFromObject` is deprecated.  Please use syntax `parent_object.related_objects.delete child_object` instead.  This has a target date for removal of 07-31-2015"

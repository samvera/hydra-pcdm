  ...
  describe '#call' do
    ...
    context 'when multiple objects' do
      ...
      it 'should remove first object when changes are in memory' do
        expect( Hydra::PCDM::RemoveObjectFromObject.call( subject, object1 ) ).to eq object1
        expect( Hydra::PCDM::GetObjectsFromObject.call( subject )).to eq [object2,object3]
      end
      ...
      it 'should remove middle object when changes are in memory' do
        ...
        expect( Hydra::PCDM::GetObjectsFromObject.call( subject )).to eq [object1,object3]
      end
    ...
    context 'when object repeats' do
      before do
        ...
        expect(Hydra::PCDM::GetObjectsFromObject.call( subject )).to eq [object1,object2,object3,object2,object3]
      end

      it 'should remove first occurrence when changes in memory' do
      skip( "pending resolution of AF-agg 46 and PCDM 102") do
        expect( Hydra::PCDM::RemoveObjectFromObject.call( subject, object2 ) ).to eq object2
        expect( Hydra::PCDM::GetObjectsFromObject.call( subject )).to eq [object1,object3,object2,object3]
      end
      end
      ...
      skip( "pending resolution of AF-agg 46 and PCDM 102") do
        ...
        expect( Hydra::PCDM::GetObjectsFromObject.call( subject )).to eq [object1,object2,object3,object3]
      end
      end
